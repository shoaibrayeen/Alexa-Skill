...
const GetHeroTriviaIntentHandler = {
  canHandle(handlerInput) {
    return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'GetHeroTriviaIntent';
  },
  handle(handlerInput) {
    ...
    const speakOutput = `Here's your ${heroName} trivia: ${randomFact} <break time="1s"/> You can say tell me a super hero trivia to hear another one.`;
